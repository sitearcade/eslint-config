...
const extendRules = (tsRules) => Object.keys(tsRules).reduce((acc, tsRule) => {
  ...
  // Disable core rules...
  return jsRule === tsRule ? {...acc, [jsRule]: tsRules[jsRule]} :
...
module.exports = {
  ...
  rules: extendRules({
    ...
    // '@typescript-eslint/explicit-module-boundary-types': 1, // Too lazy!
    ...
    // '@typescript-eslint/prefer-readonly-parameter-types': 1, // Too lazy!
